...
const STAGED_FILE_ACCEPT =
  "image/*,application/pdf,application/zip,application/x-zip-compressed,text/plain,text/markdown,application/json,text/csv,text/html,.md,.markdown,.zip";
...
function isCodexAdapterType(adapterType: string | null | undefined): boolean {
...
function loadDraft(): IssueDraft | null {
  try {
    ...
    return {
      ...
      reviewerValue: parsed.reviewerValue ?? "",
      approverValue: parsed.approverValue ?? "",
      watchdogAgentId: parsed.watchdogAgentId ?? "",
      watchdogInstructions: parsed.watchdogInstructions ?? "",
      assigneeId: parsed.assigneeId,
      projectId: parsed.projectId ?? "",
      projectWorkspaceId: parsed.projectWorkspaceId,
      assigneeModelLane: parsed.assigneeModelLane,
      ...
      executionWorkspaceMode: parsed.executionWorkspaceMode,
      selectedExecutionWorkspaceId: parsed.selectedExecutionWorkspaceId,
...
export function NewIssueDialog() {
  ...
  useEffect(() => {
    ...
    const validThinkingValues =
      isCodexAdapterType(assigneeAdapterType)
