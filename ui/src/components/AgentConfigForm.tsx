...
const CODEX_SUBSCRIPTION_2_DEFAULT_MODEL = "gpt-5.6-terra";
...
export function supportsAdapterModelRefresh(adapterType: string): boolean {
  return adapterType === "claude_local" || isCodexAdapterType(adapterType) || adapterType === "paperclip_runner" || adapterType === "opencode_local";
}
