...
function Setup({
  ...
  function buildConfig(
    ...
    const values = {
      ...
      adapterType,
      model:
        model || (adapterType === "codex_subscription_2_local" ? "gpt-5.6-terra" : brandType === "codex_local" ? DEFAULT_CODEX_LOCAL_MODEL : ""),
      thinkingEffort: effort || (adapterType === "codex_subscription_2_local" ? "xhigh" : ""),
      dangerouslyBypassSandbox: adapterType === "codex_local" || adapterType === "codex_subscription_2_local",
