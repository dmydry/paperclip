...
export const DEFAULT_PAPERCLIP_AGENT_PROMPT_TEMPLATE = [
  ...
  "- If woken after an accepted plan confirmation, do not close the source issue as merely approved. Check GET /api/issues/{issueId}/accepted-plan-decompositions, then create the approved children through POST /api/issues/{issueId}/accepted-plan-decompositions using the accepted plan revision id. For sprint backlog batches, set child status explicitly to backlog; use todo only when execution should start now.",
