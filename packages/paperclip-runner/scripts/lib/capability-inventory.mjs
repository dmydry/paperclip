...
export function validateInventories(inventories) {
  const errors = [];
  // Local skill headings are checked one-for-one against live source by the
  // inventory checker. Their count is not an external corpus constant.
  const expectedCounts = { evaluations: 106, legacyMcpAliases: 42 };
